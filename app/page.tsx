    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 py-2 flex items-center justify-between">
          <img src="/logo.png" alt="WC Hauling Polk" className="h-60 w-auto" />
      ...
      {/* Hero */}
      <section className="pt-64 bg-gradient-to-br from-green-700 to-green-900 text-white">
      ...
      <footer className="bg-black text-gray-400 py-8 text-center text-sm">
        <img src="/logo.png" alt="WC Hauling Polk" className="h-48 w-auto mx-auto mb-3" style={{ filter: "brightness(0) invert(1)" }} />
